...
;;
;; Copyright © 1997-2016 Emmanuel Rouat <no-email>
...
(defconst eldo-mode-version "1.3.6 January 2016"
...
(defcustom eldo-section-alist
  '(
    ...
    ;; MonteCarlo Analysis
    ("MonteCarlo Analysis" "MonteCarlo ANALYSIS" nil) ;
...
(defconst eldo-analysis-keywords
  '(
    "ac" "age" "checksoa" "conso" "dc" "four" "lstb" "mc" "mprun"
    "noise" "noisetran" "op" "optimize" "pz" "sens" "snf" "sst" "sstac" "sstnoise"
...
(defconst eldo-commands
  '(
    ...
    "d2a" "data" "defhook" "define_testbench" "define_task"
    "defmac" "defplotdig" "defwave"
    "del" "distrib" "disflat" "dspf_include"
    "end" "ends" "enddata" "endl" "end_define_testbench" "end_define_task"
    "extmod" "extract"
    "ffile" "func"
    "global" "guess" "hier"
    "ic"  "include" "init" "iprobe"
    "lib" "libfas" "load" "loop" "lotgroup" "localtol"
    "mcmod" "moddup" "modlogic" "monitor" "meas"
    "newpage" "nocom" "nodeset" "notrc"
    "objective" "optfour" "option" "options"
    "optnoise" "optpwl" "optwind"
    "param" "paramopt" "plotbus" "plotwind" "printbus" "probe" "protect"
...
;;   '("![^*\n].*" 0 eldo-doc-face t)
   ...
   (list
    (concat
     ...
     (regexp-opt '( "ac" "dc" "dcac" "dcsweep" "extract" "mc" "tran" "dctran" "noise"
		    "four" "sweep" "opt"
		    "fsst" "tsst" "sstac" "sstnoise"
		    ) t )
     "\\>" )
     '(0  eldo-output-face))
  ...
  (if (file-exists-p "~/.eldo")
    ...
    (insert
     (concat "\n\n\n"
	     ...
	     ".options eps=1e-7 itol=1e-6 gmin=1e-16 \n"
...
Copyright © 1997-2011 Emmanuel Rouat <no-email>"
